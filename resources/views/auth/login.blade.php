      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        ...
        <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{route('/')}}" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder" style="text-transform:capitalize">AIT Computer</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to AIT Computer</h4>
          ...
          @endif
              ...
              <form id="formAuthentication" action="{{route('loginSave')}}" class="mb-3"  method="POST">
                @csrf
                <div class="mb-3">
